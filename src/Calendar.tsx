              ...
              <tbody>
                <CalendarDayRow
                  ...
                  events={events!.filter(
                    (event) => getDay(parseISO(event.start?.dateTime!)) === 0
                  )}
                />
                <CalendarDayRow
                  ...
                  timeFormat={app.user?.timeFormat!}
                  events={events!.filter(
                    (event) => getDay(parseISO(event.start?.dateTime!)) === 1
                  )}
                />
                <CalendarDayRow
                  ...
                  timeFormat={app.user?.timeFormat!}
                  events={events!.filter(
                    (event) => getDay(parseISO(event.start?.dateTime!)) === 2
                  )}
                />
                <CalendarDayRow
                  ...
                  timeFormat={app.user?.timeFormat!}
                  events={events!.filter(
                    (event) => getDay(parseISO(event.start?.dateTime!)) === 3
                  )}
                />
                <CalendarDayRow
                  ...
                  timeFormat={app.user?.timeFormat!}
                  events={events!.filter(
                    (event) => getDay(parseISO(event.start?.dateTime!)) === 4
                  )}
                />
                <CalendarDayRow
                  ...
                  timeFormat={app.user?.timeFormat!}
                  events={events!.filter(
                    (event) => getDay(parseISO(event.start?.dateTime!)) === 5
                  )}
                />
                <CalendarDayRow
                  ...
                  timeFormat={app.user?.timeFormat!}
                  events={events!.filter(
                    (event) => getDay(parseISO(event.start?.dateTime!)) === 6
                  )}
                />
              </tbody>
            </Table>
